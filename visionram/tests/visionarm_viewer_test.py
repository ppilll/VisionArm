#!/usr/bin/env python3
"""Pure-Python regression tests for the ffplay/telemetry viewer."""
...
from visionarm_viewer import (  # noqa: E402
...
class FfplayCommandTest(unittest.TestCase):
    def test_command_uses_the_verified_low_latency_path(self) -> None:
