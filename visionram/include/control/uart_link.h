...
// Protocol-domain control value accepted by the UART module.
//
// Pipeline interpretation and float/fixed-point conversion belong to the
// control adapter. The link only applies transport-time freshness and encodes
// these already-normalized protocol-domain fields.
