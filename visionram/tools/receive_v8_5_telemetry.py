#!/usr/bin/env python3
"""Receive and validate VisionArm V8.5 JSON UDP telemetry."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Capture and validate V8.5 side telemetry")
...
def main() -> int:
    ...
    lines = [
        ...
        "v8_5_telemetry_validation=PASS" if passed else
        "v8_5_telemetry_validation=FAIL",
    ]
